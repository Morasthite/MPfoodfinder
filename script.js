...
//----------------- FourSquare Return, Sorting Restaurant Distance and prices -----------------//
    ...
    var j = 0;
    var temp = null;
    //loops through the array starting at its last index and decrements down until it reaches the first index
...
//----------------- DISPLAY TO DOM -----------------//
    ...
    function results_to_DOM (array,fav) {
        ...
        for(var i = 0; i<10; i++){
          //creation of the various elements  for each card and adding the information from foursquare object array that has been sorted
          //div element changes it color per each iteration by iterating through the color array and adding that specific color
    ...
    //function for moving cards up from out of the viewable window to into the viewable window takes in the card_array
